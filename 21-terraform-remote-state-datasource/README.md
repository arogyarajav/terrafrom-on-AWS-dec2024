...
[![Image](https://terraform-learning.com/course-images/terraform-remote-state-datasource-1.png "Terraform on AWS with IAC DevOps and SRE")](https://terraform-learning.com/course-images/terraform-remote-state-datasource-1.png)

[![Image](https://terraform-learning.com/course-images/terraform-remote-state-datasource-2.png "Terraform on AWS with IAC DevOps and SRE")](https://terraform-learning.com/course-images/terraform-remote-state-datasource-2.png)

[![Image](https://terraform-learning.com/course-images/terraform-remote-state-datasource-3.png "Terraform on AWS with IAC DevOps and SRE")](https://terraform-learning.com/course-images/terraform-remote-state-datasource-3.png)

[![Image](https://terraform-learning.com/course-images/terraform-remote-state-datasource-4.png "Terraform on AWS with IAC DevOps and SRE")](https://terraform-learning.com/course-images/terraform-remote-state-datasource-4.png)

[![Image](https://terraform-learning.com/course-images/terraform-remote-state-datasource-5.png "Terraform on AWS with IAC DevOps and SRE")](https://terraform-learning.com/course-images/terraform-remote-state-datasource-5.png)

[![Image](https://terraform-learning.com/course-images/terraform-remote-state-datasource-6.png "Terraform on AWS with IAC DevOps and SRE")](https://terraform-learning.com/course-images/terraform-remote-state-datasource-6.png)

[![Image](https://terraform-learning.com/course-images/terraform-remote-state-datasource-7.png "Terraform on AWS with IAC DevOps and SRE")](https://terraform-learning.com/course-images/terraform-remote-state-datasource-7.png)
