...
kubectl set image deployment/my-first-deployment kubenginx=terraform-learning/kubenginx:2.0.0 --record=true
```
...
# Change From 2.0.0
    spec:
      containers:
      - image: terraform-learning/kubenginx:2.0.0

# Change To 3.0.0
    spec:
      containers:
      - image: terraform-learning/kubenginx:3.0.0
```
