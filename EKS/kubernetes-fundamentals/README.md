...
| ----------------- | ----------------- |
| Simple Nginx V1  | terraform-learning/kubenginx:1.0.0  |
| Spring Boot Hello World API  | terraform-learning/kube-helloworld:1.0.0  |
| Simple Nginx V2  | terraform-learning/kubenginx:2.0.0  |
| Simple Nginx V3  | terraform-learning/kubenginx:3.0.0  |
| Simple Nginx V4  | terraform-learning/kubenginx:4.0.0  |
| Backend Application  | terraform-learning/kube-helloworld:1.0.0  |
| Frontend Application  | terraform-learning/kube-frontend-nginx:1.0.0  |
