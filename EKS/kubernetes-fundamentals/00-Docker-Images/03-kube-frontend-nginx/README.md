...
- **Important Note**: In the below listed commands wherever you see **terraform-learning** you can replace with your docker hub account id. 
...
```
# Build Docker Image
docker build -t terraform-learning/kube-frontend-nginx:1.0.0 .
...
docker push terraform-learning/kube-frontend-nginx:1.0.0 
