...
kubectl run my-first-pod --image terraform-learning/kubenginx:1.0.0 --generator=run-pod/v1
```
...
```
kubectl run my-first-pod --image terraform-learning/kubenginx:1.0.0
```  
